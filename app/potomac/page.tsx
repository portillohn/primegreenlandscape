...
export const metadata = {
    title: "Lawn Care Potomac MD | Prime Green Landscape LLC",
    description: "Professional lawn mowing and maintenance in Potomac, MD (20854, 20859). Instant quotes, no contracts. Call 571-405-0031.",
};
    ...
    return (
        <main className="min-h-screen">
            ...
            <section className="relative bg-[#0f2419] text-white py-24 px-4 overflow-hidden">
                ...
                <div className="relative z-10 max-w-4xl mx-auto text-center space-y-6">
                    ...
                    <p className="text-lg md:text-xl max-w-2xl mx-auto text-white/90 drop-shadow">
                        Serving 20854, 20859. Get an instant quote for your Potomac home — no contracts, pay after each visit.
                    </p>
                    <div className="pt-4">
            ...
            <section className="py-20 px-4 bg-white">
                <div className="max-w-5xl mx-auto">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-4xl font-black text-gray-900">Why Potomac Homeowners Choose Prime Green</h2>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="bg-gray-50 p-8 rounded-3xl border border-gray-100">
                            <span className="text-4xl mb-4 block">⚡</span>
                            <h3 className="text-xl font-bold text-gray-900 mb-2">Instant Quote</h3>
                            <p className="text-gray-500">Satellite-based pricing for any Potomac property in 60 seconds.</p>
                        </div>
                        <div className="bg-gray-50 p-8 rounded-3xl border border-gray-100">
                            <span className="text-4xl mb-4 block">🌿</span>
            ...
            <section className="py-20 px-4 bg-gray-50">
                <div className="max-w-5xl mx-auto">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-4xl font-black text-gray-900">Simple, Transparent Pricing in Potomac</h2>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {/* Essential */}
                ...
                <div className="max-w-3xl mx-auto space-y-12">
                    ...
                    <div className="space-y-8">
                        <div className="bg-gray-50 p-6 rounded-2xl">
                            <h3 className="text-lg font-bold text-gray-900 mb-2">Do you serve all of Potomac?</h3>
                            <p className="text-gray-600">Yes, we serve all ZIP codes in Potomac including 20854, 20859.</p>
                        </div>
                        <div className="bg-gray-50 p-6 rounded-2xl">
                            <h3 className="text-lg font-bold text-gray-900 mb-2">How do I get a quote for my Potomac home?</h3>
            ...
            <section className="py-24 px-4 bg-[#1B4332] text-white text-center">
                <h2 className="text-3xl md:text-4xl font-black mb-6">Ready for a Perfect Lawn in Potomac?</h2>
